...
export default function Page8({id, data}) {
    ...
    const handleSendRsvp = (e) =>{
        ...
        if (name === '' || select === '') {
            ...
            const rsvp = ref(database, `weddings-love-3/${id}/rsvp/${Date.now()}`)
            set(rsvp, {
                name,
                confirm:select,
                jumlah,
            ...
            <div className={style.rsvp}>
                ...
                <form 
                    ...
                    <div className='flex pt-5 justify-center'>
                        <button 
                            ...
                            className='py-2 px-4 rounded-md bg-[#496937] bg-opacity-80 text-white  mx-auto'
                            >
                ...
                <div className='relative z-10'>
                    ...
                    <div className='flex justify-center'>
                        <button 
                            onClick={handleGift}
                            className=' bg-[#496937] bg-opacity-80 text-white py-2 px-4 rounded-md'>Open Gift</button>
                        </div>
                    <div className={`${gift ? ' max-h-[200rem] opacity-100' : ' max-h-0 opacity-0 '} transition-all duration-500 ease-in-out  overflow-hidden w-full  py-5`}>
                        {data?.gift?.one?.nameBank === data?.gift?.one?.nameBank ? (
                            ...
                            <button 
                                ...
                                className='w-full py-2 bg-[#1c3010]  rounded-md border border-white font-bold text-gray-100 italic flex justify-center items-center'>
