    ...
    return(
        <section className='py-10 px-2 sm:px-20'>
            <div className='text-4xl sm:text-5xl text-center font-bold pb-10'>
                ...
                <h3 className='GVibes border-b-2 border-green-800 w-72 m-auto  '>& Groom</h3>
            ...
            <div className=' text-center  p-5'>
                ...
                <div className='flex justify-center items-center pt-4'>
                    <Link href={`${data?.sosmed?.mens?.facebook}`} className='p-2 bg-[#5d7e4b] m-1 text-gray-100 rounded-full'><FaFacebookF /></Link>
                    <Link href={`${data?.sosmed?.mens?.instagram}`} className='p-2 bg-[#5d7e4b] m-1 text-gray-100 rounded-full'><AiFillInstagram /></Link>
                    <Link href={`${data?.sosmed?.mens?.twitter}`} className='p-2 bg-[#5d7e4b] m-1 text-gray-100 rounded-full'><FaTwitter /></Link>
                    <Link href={`${data?.sosmed?.mens?.tiktok}`} className='p-2 bg-[#5d7e4b] m-1 text-gray-100 rounded-full'><FaTiktok /></Link>
                </div>
            </div>
            </AnimateSee>
            <div className='flex justify-center items-center py-20 text-5xl GVibes'>
                <div className='border-b-2 border-green-800 w-20' /><span className='px-5 '>&</span><div className='border-b-2 border-green-800 w-20 ' />
            </div>
            <AnimatedSection>
            <AnimateSee>
            ...
            <div className='  text-center p-5'>
                ...
                <div className='flex justify-center items-center pt-4'>
                    <Link href={`${data?.sosmed?.grils?.facebook}`} className='p-2 bg-[#5d7e4b] m-1 text-gray-100 rounded-full'><FaFacebookF /></Link>
                    <Link href={`${data?.sosmed?.grils?.instagram}`} className='p-2 bg-[#5d7e4b] m-1 text-gray-100 rounded-full'><AiFillInstagram /></Link>
                    <Link href={`${data?.sosmed?.grils?.twitter}`} className='p-2 bg-[#5d7e4b] m-1 text-gray-100 rounded-full'><FaTwitter /></Link>
                    <Link href={`${data?.sosmed?.grils?.tiktok}`} className='p-2 bg-[#5d7e4b] m-1 text-gray-100 rounded-full'><FaTiktok /></Link>
                </div>
            </div>
            </AnimateSee>
        </section>
