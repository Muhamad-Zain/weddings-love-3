    ...
    return(
        <section>
            <div className='text-4xl sm:text-5xl text-center pt-10'>
                ...
                <h3 className='GVibes border-b-2 border-green-800 w-72 m-auto '>Event</h3>
            </div>
            <AnimatedSection>
                <div  className={style.bg}>
                 <AnimateSee>
                    <h3 className='text-center z-10 relative text-2xl GVibes font-semibold border-b-2 border-green-800 w-40 mx-auto'>Akad Nikah</h3>
                    <div className='relative z-10 text-center py-5 text-sm '>
                        ...
                        <Link href={`${data?.location?.akad}`} className='py-2 w-48 m-auto flex justify-center items-center rounded-md bg-[#496937] text-white bg-opacity-80 text-lg '>
                ...
                <div className={style.bg}>
                 <AnimateSee>
                    <h3 className='text-center z-10 relative text-2xl GVibes font-semibold border-b-2 border-green-800  w-40 mx-auto'>Resepsi</h3>
                    <div className='relative z-10 text-center py-5 text-sm '>
                        ...
                        <Link href={`${data?.location?.resepsi}`} className='py-2 w-48 m-auto flex justify-center items-center rounded-md bg-[#496937] text-white bg-opacity-80 text-lg '>
                            <SiGooglemaps className='mr-2' />
                            Google Maps
                        </Link>
                    </div>
