      ...
      if (completed) {
                  ...
                  return (
                      ...
                      <div className="w-full flex justify-center">
                        <button onClick={handleSaveDate} className="text-xl bg-[#496937] bg-opacity-80 border border-green-800 text-gray-100 p-2 rounded-lg">Save Date</button>
                      </div></>
                  );
                }
              };
        ...
        <section>
          <AnimatedSection>
            ...
            className={style.bgInformation}>
              <div className="relative z-10 bg-[#afe692] py-10">
                  <div className="text-center text-4xl sm:text-5xl pb-10">
                    <h3 className="font-extrabold -mb-3 playfair ">We Are</h3>
                    <h3 className="GVibes border-b-2 border-green-800 w-72 m-auto">Getting Married</h3>
                  </div>
