...
export default function AddData() {
    ...
    const auth = getAuth()
    const [idUndangan, setIdUndangan] = useState('Wl3-')
  ...
  const handleSubmit = async(e) => {
    ...
    try {
      ...
      const uploadedFiles = await uploadFiles(`weddings-love-3/${id}`, files, [
      'hero',
      'groom',
      'bride',
      'galery',
...
const login = async (email, password) => {
    ...
    return(
        <section className="max-w-[400px] bg-[#a4db85] pb-20 m-auto">
            {verify ? (
              <div>
              <h3 className="text-center text-xl w-3/4 m-auto py-5 playfair">Add Data to template weddings-love-3 </h3>
